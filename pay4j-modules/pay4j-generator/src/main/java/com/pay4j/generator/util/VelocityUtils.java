package com.pay4j.generator.util;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.Dict;
import com.pay4j.common.mybatis.enums.DataBaseType;
...
import com.pay4j.common.mybatis.helper.DataBaseHelper;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.pay4j.common.translation.annotation.Translation");
                importList.add("com.pay4j.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
