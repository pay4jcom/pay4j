package com.pay4j.workflow.service.impl;
...
import com.pay4j.workflow.common.enums.TaskAssigneeType;
import com.pay4j.workflow.common.enums.TaskStatusEnum;
import com.pay4j.workflow.domain.bo.*;
import com.pay4j.workflow.domain.context.CompleteTaskContext;
...
import com.pay4j.workflow.domain.vo.FlowCopyVo;
import com.pay4j.workflow.domain.vo.FlowHisTaskVo;
import com.pay4j.workflow.domain.vo.FlowTaskVo;
import com.pay4j.workflow.domain.vo.NodeExtVo;
import com.pay4j.workflow.mapper.FlwCategoryMapper;
import com.pay4j.workflow.mapper.FlwHisTaskMapper;
import com.pay4j.workflow.mapper.FlwTaskMapper;
import com.pay4j.workflow.service.IFlwCommonService;
import com.pay4j.workflow.service.IFlwNodeExtService;
import com.pay4j.workflow.service.IFlwTaskAssigneeService;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public void setCopy(Task task, List<FlowCopyBo> flowCopyList) {
        ...
        flwCommonService.sendMessage(
            List.of(com.pay4j.workflow.common.enums.MessageTypeEnum.SYSTEM_MESSAGE.getCode()),
            "您收到一条新的流程抄送，请及时查看。",
            "单据抄送提醒",
