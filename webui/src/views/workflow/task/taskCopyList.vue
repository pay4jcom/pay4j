...
<template>
  <Page :auto-content-height="true">
    <div class="flex h-full gap-2">
      <div
        class="bg-card relative flex h-full max-w-[320px] min-w-[320px] flex-col rounded-lg"
      >
        <!-- 搜索条件 -->
        <div
          class="bg-card sticky top-0 left-0 z-100 w-full rounded-t-lg border-b-[1px] border-solid p-2"
        >
        ...
        <!-- total显示 -->
        <div
          class="bg-card sticky bottom-0 w-full rounded-b-lg border-t-[1px] py-2"
        >
