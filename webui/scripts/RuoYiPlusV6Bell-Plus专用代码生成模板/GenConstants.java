...
public interface GenConstants {
     ...
     * 默认前端模板类型，对应模板根目录下的 vue 目录。
     */
    String FRONTEND_TYPE_BELL = "bell";
    ...
    String FRONTEND_INDEX_DATA_TEMPLATE_PREFIX = "data";
    String FRONTEND_INDEX_SEARCH_TEMPLATE_PREFIX = "search";
    String FRONTEND_INDEX_POPUP_TEMPLATE_PREFIX = "popup";
