...
import com.pay4j.common.core.domain.model.RegisterBody;
import com.pay4j.common.core.domain.model.SocialLoginBody;
import com.pay4j.common.encrypt.annotation.ApiEncrypt;
import com.pay4j.common.json.utils.JsonUtils;
import com.pay4j.common.ratelimiter.annotation.RateLimiter;
import com.pay4j.common.ratelimiter.enums.LimitType;
...
import com.pay4j.common.sse.dto.SseMessageDto;
import com.pay4j.common.sse.utils.SseMessageUtils;
import com.pay4j.common.tenant.helper.TenantHelper;
import com.pay4j.system.domain.bo.SysTenantBo;
...
import com.pay4j.system.service.ISysTenantService;
import com.pay4j.web.domain.vo.LoginTenantVo;
import com.pay4j.web.domain.vo.LoginVo;
import com.pay4j.web.domain.vo.TenantListVo;
...
public class AuthController {
    ...
    public R<LoginVo> login(@RequestBody String body) {
        ...
        scheduledExecutorService.schedule(() -> {
            ...
            dto.setMessage("欢迎登录Pay4j后台管理系统");
